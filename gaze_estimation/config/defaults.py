...
# config.face_detector.dlib.model = 'tools/dlib/shape_predictor_68_face_landmarks.dat'
...
config.face_detector.dlib_model_path = 'tools/dlib/shape_predictor_68_face_landmarks.dat'
...
config.gaze_estimator.normalized_camera_params = 'tools/calib/normalized_camera_params_eye.yaml'
